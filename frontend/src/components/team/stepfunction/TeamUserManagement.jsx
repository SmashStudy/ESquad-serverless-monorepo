...
import {Box, Typography, Stack, TextField, Button, useTheme, alpha} from '@mui/material';
...
function TeamUserManagement({ teamUsers = [], newTeamUser, handlenewTeamUserChange, searchUser, searchError, removeTeamUser, makerEmail }) {
    ...
    return (
        <Box sx={{ pt: 2 }}>
            ...
            <Typography sx={{ mt: 2, mb: 1, fontSize: 'large', color: theme.palette.info.main, textAlign: 'center'}}>
                동행할 크루를 초대하여 함께 성장해요!
            </Typography>
            <Typography sx={{mt: 0, mb: 5, fontSize: 'small', color: theme.palette.warning.main, textAlign: 'center' }}>
