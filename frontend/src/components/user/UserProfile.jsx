...
import { Box, Typography, CircularProgress, Card, CardContent, Avatar, Button, List, ListItem, ListItemIcon, ListItemText } from '@mui/material';
...
const API_URL = 'https://api.esquad.click/dev/users/get-user-info';
...
const UserProfile = () => {
  ...
  return (
    <Box sx={{ display: 'flex', height: 'calc(98vh - 55px)', backgroundColor: '#f5f5f5' }}>
      ...
      {/* Main Content */}
      <Box sx={{ flexGrow: 1, padding: 4, display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 3 }}>
        {/* Profile Picture */}
        <Card sx={{ width: '100%', maxWidth: 600, textAlign: 'center', padding: 2 }}>
          <Avatar
            sx={{
              width: 90,
              height: 90,
